...
//created a variable myNmae and using the string method, i convert my name to lowercase. just as i could assign and name a variable, but this time i added a method ".toLowerCase()". Don't forget the parenthesis
